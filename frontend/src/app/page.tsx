...
export default async function Home() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-blue-900 to-indigo-800 text-white py-20 px-4 shadow-md overflow-hidden">
        <div className="container mx-auto relative z-10 flex flex-col items-center text-center">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight leading-tight">
              Device Info? <span className="text-blue-400">we've got you covered</span>
            </h1>
            <p className="text-xl text-blue-100 mb-8 max-w-xl mx-auto">
              The most comprehensive database of Tech device specifications.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/search"
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-bold transition-all shadow-lg hover:scale-105 active:scale-95"
              >
                Search Now
              </Link>
              <Link
                href="/compare"
                className="bg-white bg-opacity-10 hover:bg-opacity-20 text-white border border-white border-opacity-30 px-8 py-3 rounded-lg font-bold transition-all hover:scale-105 active:scale-95"
              >
                Compare
              </Link>
            </div>
        ...
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-indigo-500 opacity-10 rounded-full blur-3xl"></div>
      </section>
